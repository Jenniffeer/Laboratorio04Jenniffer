...
if __name__ == "__main__":
    ...
    proveedor1 = Proveedor("P001", "Proveedor A", "Costa Rica")
    inventario.agregar_producto(Producto("PR001", "Camiseta", "MarcaX", 19.99, 50, proveedor1))
    inventario.agregar_producto(Producto("PR002", "Zapatos", "MarcaY", 59.99, 30, proveedor1))
